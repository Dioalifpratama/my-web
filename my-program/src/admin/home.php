		...
		<section  class="sky-form">
					<h4></h4><br><div class="judul"><b>Tentang</b></div>
						<div class="row1 scroll-pane">
							...
							<div class="col col-4">
								<label ><i><span><p>Tempat Tinggal:</p></span></i>Jakarta Barat, Grogol petamburan, DKI Jakarta</label>
								<label ><i><span><p>Kota Asal:</p></span></i>Jakarta</label>
...
<div class="col-md-right">
	  <div class="w_sidebar">
	<br>  <div class="judul2"><b>Promo</b></div>
		<div class="w_nav1">
			
			<ul>
				<li><a href="women.html">Diskon</a></li>
				<li><a href="#">Berhadiah</a></li>
				<li><a href="#">Undian</a></li>
				<li><a href="#">Buy 1get1 Free</a></li>
			
			</ul>	
		</div>
		
		<section  class="sky-form">
					<br><div class="judul2"><b>Admin Aktif</b></div>
						<div class="row1-2 scroll-pane">
							<div class="col col-4">
							<?php
   $data=mysql_query ('select * from tab_user');
	$no=1;
   while ($row =mysql_fetch_assoc($data)) { ?>	<label class="checkbox"><i><div class="obrolan"><img src="../images/user.png" class="img-responsive " alt=""/></div></i><a href="#"><?php echo $row['username'] ?></a></label><?php $no++; }?>
							</div>
							<div class="col col-4">
...
<div class="new_posts">
 ...
 <!--mulai form upload-->
							...
							<a class="popup-with-zoom-anim"  href="#small-dialog"><b>Update Promo &nbsp;</b><img src="../images/tambah.gif"></a>
		...
		<form method="post" action="../proses/proses-quotes.php">
								<span>
									
								</span>
								
						
								<span><textarea type="text" name="quotes" size="100" placeholder="Apa motivasi hari ini" required > </textarea></span>
									<div class="clear"></div>
			...
			<!-- /Form --></div>
						...
						<div class="vertical_post">
							<form method="post" action="../proses/proses-berita.php">
								...
								<span><input type="file" name="file" size="50" placeholder="Isi Posting:" > </textarea></span>
...
{
echo"<div class='container-posting2'><div class='content-posting2'></div> 
	 <div class='product'>
								<div class='product-img'>
		                           <img src='../images/pick.jpg' class='img-responsive ' alt=''/>
		                       </div><div class='prod2-desc'>
	...
	<footer-post>
		<ul class='s_icons'>  
					...
					<li><a href='delet-posting.php?id_hubungi=$r[id_hubungi]'><img src='../images/s_icon3.png' alt=''></a></li>
					<li><span></b>&nbsp;&nbsp;</span></li>
				</ul>
				</div> <br>";
} ?>
